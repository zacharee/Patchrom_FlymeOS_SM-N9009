...
.method private readProfileStateFromFileLocked(Ljava/io/FileInputStream;ILjava/util/List;)I
    ...
    .line 2679
    .local v14, "legacyProviderIndex":I
    const/4 v13, -0x1

    .line 2680
    .local v13, "legacyHostIndex":I
    const/4 v12, 0x0
    ...
    .line 2872
    .end local v12    # "legacy":Z
    .end local v13    # "legacyHostIndex":I
    .end local v14    # "legacyProviderIndex":I
    ...
    .restart local v12    # "legacy":Z
    .restart local v13    # "legacyHostIndex":I
    .restart local v14    # "legacyProviderIndex":I
    ...
    .line 2713
    .local v28, "providerInfo":Landroid/content/pm/ActivityInfo;
    if-eqz v28, :cond_1
    ...
    .line 2718
    .local v27, "providerId":Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;
    move-object/from16 v0, p0
    ...
    .line 2720
    .local v26, "provider":Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;
    if-nez v26, :cond_3
    ...
    .end local v26    # "provider":Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;
    const/16 v38, 0x0
    ...
    .line 2723
    .restart local v26    # "provider":Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;
    ...
    .end local v26    # "provider":Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;
    .end local v27    # "providerId":Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;
    .end local v28    # "providerInfo":Landroid/content/pm/ActivityInfo;
    .end local v30    # "providerTag":I
    .end local v32    # "tag":Ljava/lang/String;
    ...
    .restart local v26    # "provider":Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;
    .restart local v27    # "providerId":Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;
    .restart local v28    # "providerInfo":Landroid/content/pm/ActivityInfo;
    .restart local v32    # "tag":Ljava/lang/String;
    .restart local v33    # "tagAttribute":Ljava/lang/String;
    .restart local v34    # "type":I
    .restart local v35    # "uid":I
    :cond_4
    shl-int/lit8 v38, p2, 0x10

    or-int v30, v38, v14

    .line 2757
    .restart local v30    # "providerTag":I
    const/4 v12, 0x1
    ...
    invoke-direct {v9, v0}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;-><init>(Lcom/android/server/appwidget/AppWidgetServiceImpl$1;)V
    ...
    .line 2790
    .restart local v9    # "host":Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;
    .restart local v10    # "hostId":I
    .restart local v12    # "legacy":Z
    .restart local v13    # "legacyHostIndex":I
    .restart local v14    # "legacyProviderIndex":I
    .restart local v24    # "parser":Lorg/xmlpull/v1/XmlPullParser;
    ...
    .line 2802
    .local v22, "packageId":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/lang/Integer;Ljava/lang/String;>;"
    move-object/from16 v0, p0
    ...
    .end local v13    # "legacyHostIndex":I
    .end local v14    # "legacyProviderIndex":I
    .end local v22    # "packageId":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/lang/Integer;Ljava/lang/String;>;"
    ...
    invoke-direct/range {v37 .. v38}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;-><init>(Lcom/android/server/appwidget/AppWidgetServiceImpl$1;)V
    ...
    .line 2817
    .local v19, "minWidthString":Ljava/lang/String;
    if-eqz v19, :cond_b

    .line 2818
    const-string v38, "appWidgetMinWidth"
    ...
    .line 2822
    .local v18, "minHeightString":Ljava/lang/String;
    if-eqz v18, :cond_c

    .line 2823
    const-string v38, "appWidgetMinHeight"
    ...
    .line 2827
    .local v17, "maxWidthString":Ljava/lang/String;
    if-eqz v17, :cond_d

    .line 2828
    const-string v38, "appWidgetMaxWidth"
    ...
    .line 2832
    .local v16, "maxHeightString":Ljava/lang/String;
    if-eqz v16, :cond_e

    .line 2833
    const-string v38, "appWidgetMaxHeight"
    ...
    const-string v39, "host_category"
    ...
    .line 2838
    const-string v38, "appWidgetCategory"
    ...
    .line 2847
    .local v29, "providerString":Ljava/lang/String;
    if-eqz v29, :cond_13
    ...
    .line 2857
    .end local v21    # "pTag":I
    .restart local v30    # "providerTag":I
    :goto_7
    new-instance v15, Lcom/android/server/appwidget/AppWidgetServiceImpl$LoadedWidgetState;
    ...
    invoke-direct {v15, v0, v1, v11, v2}, Lcom/android/server/appwidget/AppWidgetServiceImpl$LoadedWidgetState;-><init>(Lcom/android/server/appwidget/AppWidgetServiceImpl;Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;II)V

    .line 2859
    .local v15, "loadedWidgets":Lcom/android/server/appwidget/AppWidgetServiceImpl$LoadedWidgetState;
    ...
    .end local v13    # "legacyHostIndex":I
    .end local v14    # "legacyProviderIndex":I
    .end local v15    # "loadedWidgets":Lcom/android/server/appwidget/AppWidgetServiceImpl$LoadedWidgetState;
    .end local v16    # "maxHeightString":Ljava/lang/String;
    .end local v17    # "maxWidthString":Ljava/lang/String;
    .end local v18    # "minHeightString":Ljava/lang/String;
    .end local v19    # "minWidthString":Ljava/lang/String;
    .end local v20    # "options":Landroid/os/Bundle;
    .end local v24    # "parser":Lorg/xmlpull/v1/XmlPullParser;
    .end local v29    # "providerString":Ljava/lang/String;
    .end local v30    # "providerTag":I
    .end local v31    # "restoredIdString":Ljava/lang/String;
    .end local v32    # "tag":Ljava/lang/String;
    .end local v34    # "type":I
    .end local v37    # "widget":Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;
    :catch_4
    move-exception v7
    ...
    .restart local v14    # "legacyProviderIndex":I
    .restart local v24    # "parser":Lorg/xmlpull/v1/XmlPullParser;
    .restart local v31    # "restoredIdString":Ljava/lang/String;
    .restart local v32    # "tag":Ljava/lang/String;
    .restart local v34    # "type":I
    .restart local v37    # "widget":Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;
    :cond_10
    const/16 v38, 0x10
    ...
    .restart local v8    # "hTag":I
    .restart local v16    # "maxHeightString":Ljava/lang/String;
    .restart local v17    # "maxWidthString":Ljava/lang/String;
    .restart local v18    # "minHeightString":Ljava/lang/String;
    .restart local v19    # "minWidthString":Ljava/lang/String;
    ...
    .line 2849
    .restart local v11    # "hostTag":I
    .restart local v21    # "pTag":I
    .restart local v29    # "providerString":Ljava/lang/String;
    :cond_12
    shl-int/lit8 v38, p2, 0x10
