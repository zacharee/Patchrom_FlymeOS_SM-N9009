...
.method constructor <init>(Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;II)V
    ...
    .line 429
    iput v2, p0, Lcom/android/server/am/ActivityStack;->mStackExtraType:I
...
.method private isStackVisible()Z
    ...
    const-string v11, "isStackVisible: stack is not exist. id="
    ...
    .line 1629
    :cond_3
    invoke-virtual {v4, v8}, Lcom/android/server/am/TaskRecord;->getVisibleObscuredZone(Z)I

    move-result v5

    .line 1630
    .local v5, "taskObscuredZone":I
    if-ne v1, p0, :cond_6
...
.method final finishCurrentActivityLocked(Lcom/android/server/am/ActivityRecord;IZ)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/am/TaskRecord;->topRunningActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
...
.method final isVRStack()Z
    ...
    iget v1, p0, Lcom/android/server/am/ActivityStack;->mStackExtraType:I
...
.method final moveTaskToBackLocked(ILcom/android/server/am/ActivityRecord;)Z
    ...
    const-string v24, "moveTaskToBack: bad taskId="
    ...
    const-string v24, "moveTaskToBack: "
    ...
    invoke-interface/range {v22 .. v23}, Landroid/app/IActivityController;->activityResuming(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/server/Watchdog;->setActivityController(Landroid/app/IActivityController;)V
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/server/am/MultiWindowPolicy;->notifyTaskStopped(I)V

    .line 4670
    const/16 v22, 0x0

    invoke-virtual/range {v21 .. v22}, Lcom/android/server/am/TaskRecord;->topRunningActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual/range {v22 .. v24}, Lcom/android/server/am/ActivityStackSupervisor;->updateFocusedStack(Lcom/android/server/am/ActivityStack;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v22 .. v24}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->isOverHomeStack()Z
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/samsung/android/multiwindow/MultiWindowStyle;->isSplit()Z
    ...
    invoke-virtual/range {v22 .. v24}, Lcom/android/server/wm/WindowManagerService;->prepareMutiWindowTransition(Landroid/os/IBinder;I)V
    ...
    .restart local v16    # "task":Lcom/android/server/am/TaskRecord;
    :cond_e
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->getRootActivity()Lcom/android/server/am/ActivityRecord;

    move-result-object v14

    .line 4742
    .local v14, "root":Lcom/android/server/am/ActivityRecord;
    if-eqz v14, :cond_f
    ...
    invoke-virtual/range {v22 .. v24}, Lcom/android/server/wm/WindowManagerService;->setAppVisibility(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/am/ActivityStackSupervisor;->resumeTopActivitiesLocked()Z
    ...
    .line 4764
    .local v19, "top":Lcom/android/server/am/TaskRecord;
    if-eqz v19, :cond_12
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->isRecentTask()Z
    ...
    .end local v19    # "top":Lcom/android/server/am/TaskRecord;
    :cond_12
    ...
    .line 4775
    .local v18, "taskToReturnTo":I
    const/16 v22, 0x0

    invoke-virtual/range {v21 .. v22}, Lcom/android/server/am/TaskRecord;->setTaskToReturnTo(I)V
    ...
    .line 4779
    .end local v14    # "root":Lcom/android/server/am/ActivityRecord;
    .end local v15    # "size":I
    .end local v18    # "taskToReturnTo":I
    :cond_13
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/am/ActivityStackSupervisor;->scheduleIdleLocked()V
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;I)V
    ...
    .line 4566
    :goto_1
    iput-boolean v7, p1, Lcom/android/server/am/TaskRecord;->bHidden:Z
...
.method public setMultiWindowStyle(Landroid/os/IBinder;Lcom/samsung/android/multiwindow/MultiWindowStyle;ZZLandroid/os/Bundle;)V
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/am/MultiWindowPolicy;->getTabFrontStack()I
    ...
    invoke-static/range {v30 .. v30}, Lcom/samsung/android/multiwindow/MultiWindowFeatures;->isSupportTabPenWindow(Landroid/content/Context;)Z
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/am/ActivityStackSupervisor;->getStacks()Ljava/util/ArrayList;
    ...
    .line 5346
    .local v27, "topActivityRecord":Lcom/android/server/am/ActivityRecord;
    if-eqz v27, :cond_9
    ...
    .line 5352
    .local v28, "topMultiWindowStyle":Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    .end local v27    # "topActivityRecord":Lcom/android/server/am/ActivityRecord;
    .end local v28    # "topMultiWindowStyle":Lcom/samsung/android/multiwindow/MultiWindowStyle;
    :catchall_0
    move-exception v30
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/am/MultiWindowPolicy;->getTabs()Ljava/util/List;
    ...
    .line 5365
    .restart local v27    # "topActivityRecord":Lcom/android/server/am/ActivityRecord;
    if-eqz v27, :cond_c
    ...
    .line 5369
    .restart local v28    # "topMultiWindowStyle":Lcom/samsung/android/multiwindow/MultiWindowStyle;
    move-object/from16 v0, p0
    ...
    .line 5370
    .local v15, "oldBound":Landroid/graphics/Rect;
    if-eqz v15, :cond_c
    ...
    const v33, #android:dimen@multiwindow_minimized_height#t
    ...
    .end local v15    # "oldBound":Landroid/graphics/Rect;
    .end local v19    # "stack":Lcom/android/server/am/ActivityStack;
    .end local v27    # "topActivityRecord":Lcom/android/server/am/ActivityRecord;
    .end local v28    # "topMultiWindowStyle":Lcom/samsung/android/multiwindow/MultiWindowStyle;
    :cond_d
    ...
    .line 5391
    .local v29, "topRunningRecord":Lcom/android/server/am/ActivityRecord;
    move-object/from16 v21, v18

    .line 5392
    .local v21, "targetRecord":Lcom/android/server/am/ActivityRecord;
    if-eqz v29, :cond_e
    ...
    .line 5426
    .end local v21    # "targetRecord":Lcom/android/server/am/ActivityRecord;
    .end local v29    # "topRunningRecord":Lcom/android/server/am/ActivityRecord;
    :goto_4
    if-eqz v7, :cond_20
    ...
    .line 5431
    .local v22, "targetStack":Lcom/android/server/am/ActivityStack;
    move-object/from16 v0, v18
    ...
    .line 5435
    .local v24, "taskList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    move-object/from16 v0, v18
    ...
    .line 5398
    .end local v9    # "i$":Ljava/util/Iterator;
    .end local v22    # "targetStack":Lcom/android/server/am/ActivityStack;
    .end local v23    # "task":Lcom/android/server/am/TaskRecord;
    .end local v24    # "taskList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    :cond_10
    move-object/from16 v0, v18
    ...
    invoke-virtual/range {v32 .. v33}, Lcom/android/server/wm/WindowManagerService;->getStackBound(I)Landroid/graphics/Rect;
    ...
    .line 5443
    .restart local v9    # "i$":Ljava/util/Iterator;
    .restart local v22    # "targetStack":Lcom/android/server/am/ActivityStack;
    .restart local v24    # "taskList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    :cond_16
    const/4 v10, 0x0
    ...
    new-instance v32, Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    invoke-direct/range {v32 .. v33}, Lcom/samsung/android/multiwindow/MultiWindowStyle;-><init>(Lcom/samsung/android/multiwindow/MultiWindowStyle;)V
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/wm/WindowManagerService;->findNextFocusableFloatingStackIdFromTop()I

    move-result v14

    .line 5506
    .local v14, "nextStackId":I
    const/16 v30, -0x1
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/am/ActivityManagerService;->setFocusedStack(I)V
    ...
    .restart local v22    # "targetStack":Lcom/android/server/am/ActivityStack;
    :cond_1e
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/am/ActivityStack;->moveToFront()V
    ...
    .line 5509
    .restart local v14    # "nextStackId":I
    :cond_21
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/am/TaskRecord;->touchActiveTime()V
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/am/ActivityStackSupervisor;->topRunningActivityLocked()Lcom/android/server/am/ActivityRecord;

    move-result-object v13

    .line 5514
    .local v13, "newTop":Lcom/android/server/am/ActivityRecord;
    if-eqz v13, :cond_22
