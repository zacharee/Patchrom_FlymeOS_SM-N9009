...
.method public getS69BssInfo(Ljava/lang/String;)Landroid/net/wifi/S69BssInfo;
    ...
    .line 2829
    sget-object v3, Landroid/net/wifi/S69BssInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v3, v1}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/net/wifi/S69BssInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 2836
    .local v2, "_result":Landroid/net/wifi/S69BssInfo;
    :goto_0
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 2832
    .end local v2    # "_result":Landroid/net/wifi/S69BssInfo;
    :cond_0
    const/4 v2, 0x0

    .restart local v2    # "_result":Landroid/net/wifi/S69BssInfo;
    goto :goto_0
