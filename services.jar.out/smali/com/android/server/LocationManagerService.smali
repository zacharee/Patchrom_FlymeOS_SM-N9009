...
.field private static gpsBlackList:Ljava/util/ArrayList;
...
.field private static gpsRequested:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private static gpsRequestedId:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/LocationManagerService;->gpsRequested:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/LocationManagerService;->gpsRequestedId:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/LocationManagerService;->gpsBlackList:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/server/LocationManagerService;->systemApplist:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 309
    iput-boolean v1, p0, Lcom/android/server/LocationManagerService;->isBlackListRequest:Z
    ...
    const-string v1, "Constructed, NS FLP qualcommm"
...
.method static synthetic access$1000(Lcom/android/server/LocationManagerService;)Landroid/os/PowerManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1100(Lcom/android/server/LocationManagerService;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1300(Lcom/android/server/LocationManagerService;)Landroid/app/AppOpsManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$1400(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$LocationWorkerHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
...
.method static synthetic access$2200(Lcom/android/server/LocationManagerService;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Ljava/lang/String;
...
.method static synthetic access$700()Ljava/util/ArrayList;
    ...
    .prologue
    .line 156
    sget-object v0, Lcom/android/server/LocationManagerService;->gpsBlackList:Ljava/util/ArrayList;

    return-object v0
.end method

.method static synthetic access$802(Lcom/android/server/LocationManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 156
    iput-boolean p1, p0, Lcom/android/server/LocationManagerService;->isBlackListRequest:Z

    return p1
.end method

.method static synthetic access$900(Lcom/android/server/LocationManagerService;II)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    iget-boolean v0, v0, Lcom/android/server/LocationManagerService;->isBlackListRequest:Z
    ...
    const-string v33, "handleLocationChangedLocked, change the provider of notifyLocation from Fused to GPS gpsRequested = "

    invoke-virtual/range {v32 .. v33}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v32

    sget-object v33, Lcom/android/server/LocationManagerService;->gpsRequested:Ljava/util/ArrayList;
...
.method public removeUpdates(Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    .line 2036
    .local v13, "listenerId":Ljava/lang/String;
    const-string v2, "LocationManagerService"
    ...
    const-string/jumbo v4, "receiver.id = "
    ...
    const-string v4, " / gpsRequestedId = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget-object v4, Lcom/android/server/LocationManagerService;->gpsRequestedId:Ljava/util/ArrayList;
    ...
    .line 2038
    sget-object v2, Lcom/android/server/LocationManagerService;->gpsRequestedId:Ljava/util/ArrayList;
    ...
    const-string/jumbo v4, "removeUpdates, recever.mPackageName = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, v15, Lcom/android/server/LocationManagerService$Receiver;->mPackageName:Ljava/lang/String;

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, " / gpsRequested = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget-object v4, Lcom/android/server/LocationManagerService;->gpsRequested:Ljava/util/ArrayList;
    ...
    .line 2044
    sget-object v2, Lcom/android/server/LocationManagerService;->gpsRequested:Ljava/util/ArrayList;
    ...
    const-string/jumbo v4, "removeUpdatesLocked, after remove gpsRequested = "
    ...
    :cond_0
    sget-object v2, Lcom/android/server/LocationManagerService;->systemApplist:Ljava/util/ArrayList;
    ...
    const-string/jumbo v4, "removeUpdates, receiver.requestedID = "
    ...
    const-string v2, "android.intent.action.LOCATION_REQUEST"

    invoke-direct {v14, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 2054
    .local v14, "locIntent":Landroid/content/Intent;
    ...
    .line 2061
    .end local v14    # "locIntent":Landroid/content/Intent;
    :cond_1
    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Lcom/android/server/LocationManagerService;->removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 2064
    .end local v13    # "listenerId":Ljava/lang/String;
    :cond_2
    :try_start_2
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    .line 1875
    .local v15, "isBlackList":Z
    :try_start_0
    move-object/from16 v0, p0

    move-object/from16 v1, p4

    invoke-virtual {v0, v8, v1, v12}, Lcom/android/server/LocationManagerService;->checkLocationAccess(ILjava/lang/String;I)Z
    ...
    .line 1881
    sget-object v4, Lcom/android/server/LocationManagerService;->gpsBlackList:Ljava/util/ArrayList;
    ...
    .line 1882
    .local v13, "blacklist":Ljava/lang/String;
    ...
    .line 1886
    .end local v13    # "blacklist":Ljava/lang/String;
    :cond_4
    invoke-virtual/range {v19 .. v19}, Landroid/location/LocationRequest;->getProvider()Ljava/lang/String;
    ...
    const-string/jumbo v5, "requestLocationUpdates, provider is changed from GPS to FUSED for gpsBlackList"
    ...
    invoke-virtual {v0, v4}, Landroid/location/LocationRequest;->setProvider(Ljava/lang/String;)Landroid/location/LocationRequest;
    ...
    invoke-virtual {v0, v4}, Landroid/location/LocationRequest;->setIsBlacklist(Z)Landroid/location/LocationRequest;
    ...
    iput-boolean v4, v0, Lcom/android/server/LocationManagerService;->isBlackListRequest:Z
    ...
    const-string/jumbo v9, "requestLocationUpdates, gpsRequested = "

    invoke-virtual {v5, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget-object v9, Lcom/android/server/LocationManagerService;->gpsRequested:Ljava/util/ArrayList;

    invoke-virtual {v5, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v9, " / gpsRequestedId = "

    invoke-virtual {v5, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget-object v9, Lcom/android/server/LocationManagerService;->gpsRequestedId:Ljava/util/ArrayList;
    ...
    sget-object v4, Lcom/android/server/LocationManagerService;->systemApplist:Ljava/util/ArrayList;
    ...
    const-string v4, "android.intent.action.LOCATION_REQUEST"
    ...
    .line 1910
    .local v18, "locIntent":Landroid/content/Intent;
    ...
    invoke-virtual/range {v19 .. v19}, Landroid/location/LocationRequest;->getInterval()J
    ...
    .end local v18    # "locIntent":Landroid/content/Intent;
    :cond_6
    move-object/from16 v4, p0
    ...
    const-string/jumbo v5, "requestLocationUpdates, isBlacklistRequest = false"
    ...
    const-string/jumbo v5, "requestLocationUpdates,Fused, isBlacklistRequest = false"
...
.method public systemRunning()V
    ...
    const-string/jumbo v2, "systemReady(), NS FLP qualcomm"
    ...
    .line 341
    sget-object v0, Lcom/android/server/LocationManagerService;->systemApplist:Ljava/util/ArrayList;
    ...
    const-string v2, "com.sec.location.nsflp"
    ...
    .line 417
    :cond_1
    const-string v0, "android.intent.action.GPS_BLACKLIST"

    invoke-virtual {v3, v0}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 418
    const-string v0, "android.intent.action.GPS_BLACKLIST_REQUEST"
