...
.field protected isCardBootCompleted:Z
...
.method protected constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;Landroid/telephony/CellInfo;)V
    ...
    .line 255
    iput-boolean v6, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isCardBootCompleted:Z
...
.method private isRoamingBetweenOperators(ZLandroid/telephony/ServiceState;)Z
    ...
    .line 2212
    :cond_1
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->checkCtcRoamingArea()Z
...
.method private setTimeFromNITZString(Ljava/lang/String;J)V
    ...
    const-string v35, "[NITZ] setTimeFromNITZString: iso = "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v27, "set baseStationId as lteCellId: "
    ...
    const-string v27, "Handle Message EVENT_CALL_HANGUP_BEFORE_DEACTIVEPDP"
    ...
    const-string v27, "waiting before radio turn off"
    ...
    const-string v27, "EVENT_TIMEOUT_CTN mFromUserSelect = "
    ...
    const-string v27, "Handle Message EVENT_IMS_RETRYOVER"
    ...
    .line 917
    .local v24, "smsDispatcher":Lcom/android/internal/telephony/SMSDispatcher;
    if-eqz v24, :cond_0

    .line 918
    const-string v4, "CdmaSST"

    const-string v27, "Sending domain change notification"
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->isRoamingBetweenOperators(ZI)Z
    ...
    invoke-virtual {v6, v8}, Landroid/telephony/ServiceState;->setCdmaRoamingIndicator(I)V
    ...
    .line 1528
    const-string v6, "Set roaming indicator to ON in roaming network"
    ...
    invoke-virtual {v6, v4}, Landroid/telephony/ServiceState;->setCdmaEriIconIndex(I)V

    .line 1574
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mNewSS:Landroid/telephony/ServiceState;

    iget v7, p0, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->mRoamingIconMode:I
    ...
    invoke-virtual {v7}, Landroid/telephony/ServiceState;->getCdmaEriIconIndex()I
    ...
    invoke-virtual {v7}, Landroid/telephony/ServiceState;->getCdmaEriIconMode()I
...
.method protected handlePollStateResultMessage(ILandroid/os/AsyncResult;)V
    ...
    const-string v26, "handlePollStateResultMessage: EVENT_POLL_STATE_GPRS states.length="
    ...
    const-string v26, "handlPollStateResultMessage: cdma setDataRegState="
    ...
    const-string v26, " dataRadioTechnology="
    ...
    const-string v26, "handlePollStateResultMessage: error parsing GprsRegistrationState: "
    ...
    const-string v26, "set baseStationId as lteCellId: "
    ...
    invoke-virtual {v3, v0, v15}, Landroid/telephony/cdma/CdmaCellLocation;->setLteCellLocationData(II)V
    ...
    const-string v26, "EVENT_POLL_STATE_REGISTRATION_CDMA: error parsing: "
    ...
    const-string v27, "Warning! Wrong number of parameters returned from RIL_REQUEST_REGISTRATION_STATE: expected 14 or more strings and got "
    ...
    sget-object v26, Lcom/android/internal/telephony/cdma/CDMAPhone;->PROPERTY_CDMA_HOME_OPERATOR_NUMERIC:Ljava/lang/String;
    ...
    const-string v26, "RIL_REQUEST_OPERATOR.response[2], the numeric,  is bad. Using SystemProperties \'"
...
.method protected pollStateDone()V
    ...
    const-string v31, "Change hasChanged to "
    ...
    const-string v31, "gsm.voice.network.type"
    ...
    .line 1825
    const-string v30, "gsm.sim.currentcardstatus"
    ...
    .line 1828
    const-string v30, "CDMA available, set AUTO TIME"
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/telephony/cdma/CDMAPhone;->isEriFileLoaded()Z
    ...
    .line 1932
    .local v26, "serviceStateForProperty":I
    move-object/from16 v0, p0
    ...
    const-string v31, "ril.servicestate"
    ...
    .end local v26    # "serviceStateForProperty":I
    :cond_c
    if-eqz v9, :cond_d
    ...
    .end local v15    # "hasPlmnChanged":Z
    ...
    .restart local v15    # "hasPlmnChanged":Z
