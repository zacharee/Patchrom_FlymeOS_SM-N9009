...
.method public setPlaybackState(Landroid/media/session/PlaybackState;)V
    ...
    .line 405
    .local v1, "newSpeed":F
    iget v5, p0, Landroid/media/session/MediaSession;->mState:I

    if-ne v5, v4, :cond_0

    iget-wide v6, p0, Landroid/media/session/MediaSession;->mPlaybackPositionMs:J

    cmp-long v5, v6, v2

    if-nez v5, :cond_0

    iget v5, p0, Landroid/media/session/MediaSession;->mPlaybackSpeed:F
    ...
    .line 409
    iput v4, p0, Landroid/media/session/MediaSession;->mState:I

    .line 410
    iput-wide v2, p0, Landroid/media/session/MediaSession;->mPlaybackPositionMs:J

    .line 411
    iput v1, p0, Landroid/media/session/MediaSession;->mPlaybackSpeed:F

    .line 413
    :try_start_0
    iget-object v5, p0, Landroid/media/session/MediaSession;->mBinder:Landroid/media/session/ISession;

    invoke-interface {v5, p1}, Landroid/media/session/ISession;->setPlaybackState(Landroid/media/session/PlaybackState;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v6, "Dead object in setPlaybackState."
