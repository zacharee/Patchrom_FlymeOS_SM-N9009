...
.field static final SERVICE_RESTART_DURATION_KILLEBYSHRINK:I = 0x2710
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/ActiveServices;->SECURITYPOLICY:Ljava/lang/String;

    .line 138
    const-string v0, "ChinaNalSecurity"

    sget-object v1, Lcom/android/server/am/ActiveServices;->SECURITYPOLICY:Ljava/lang/String;

    invoke-virtual {v0, v1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result v0

    sput-boolean v0, Lcom/android/server/am/ActiveServices;->isChinaNal:Z
...
.method private final bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZ)Ljava/lang/String;
    ...
    iget-object v2, v2, Lcom/android/server/am/ActivityManagerService;->mSmartAdjustManager:Lcom/android/server/am/SmartAdjustManager;
    ...
    invoke-virtual {v2, v12, v4}, Lcom/android/server/am/SmartAdjustManager;->updateHotnessAdj(Lcom/android/server/am/ProcessRecord;I)V
...
.method private final scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/ServiceRecord;->killedbyShrink:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ServiceRecord;->killedbyShrink:Z
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;II)I
    ...
    .line 818
    const-string v4, "ActivityManager_SPCMtest"
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/am/SmartAdjustManager;->getShortPackageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v5, v4, Lcom/android/server/am/SmartAdjustManager;->mVpnPackageName:Ljava/lang/String;
    ...
    iget-object v2, v4, Lcom/android/server/am/ActivityManagerService;->mSmartAdjustManager:Lcom/android/server/am/SmartAdjustManager;
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/android/server/am/SmartAdjustManager;->isActivePackage(Landroid/content/ComponentName;Landroid/app/IApplicationThread;IILjava/lang/String;)Z
    ...
    const-string v5, "SPCM bind service blocked-- not in active list."
...
.method getPackageServiceScore(Lcom/android/server/am/SmartAdjustManager$PackageTable;[Landroid/content/pm/ServiceInfo;)I
    .locals 2
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/android/server/am/ActiveServices;->getPackageServiceScore(Lcom/android/server/am/SmartAdjustManager$PackageTable;[Landroid/content/pm/ServiceInfo;J)I
...
.method getPackageServiceScore(Lcom/android/server/am/SmartAdjustManager$PackageTable;[Landroid/content/pm/ServiceInfo;J)I
    .locals 11
    .param p1, "pkgtable"    # Lcom/android/server/am/SmartAdjustManager$PackageTable;
    .param p2, "sevices"    # [Landroid/content/pm/ServiceInfo;
    ...
    iget-wide v2, p1, Lcom/android/server/am/SmartAdjustManager$PackageTable;->lastServiceActivityTime:J
    ...
    const-string v8, "--- getPackageServiceScore, package = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p1, Lcom/android/server/am/SmartAdjustManager$PackageTable;->info:Landroid/content/pm/PackageInfo;
    ...
    const-string v8, " , lastActivityTime = "
    ...
    const-string v8, " , lastActivityScore = "
...
.method hasProtectedService(Lcom/android/server/am/ProcessRecord;)Z
    .locals 7
    .param p1, "app"    # Lcom/android/server/am/ProcessRecord;

    .prologue
    .line 948
    iget-object v6, p1, Lcom/android/server/am/ProcessRecord;->services:Landroid/util/ArraySet;
    ...
    iget-boolean v6, v6, Lcom/android/server/am/ProcessRecord;->killedByAm:Z
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;III)Landroid/content/ComponentName;
    ...
    sput-object v16, Lcom/android/server/am/SmartAdjustManager;->debuggingR:Lcom/android/server/am/ProcessRecord;
    ...
    sget-object v2, Lcom/android/server/am/SmartAdjustManager;->debuggingR:Lcom/android/server/am/ProcessRecord;

    if-eqz v2, :cond_8

    .line 371
    const-string v2, "ActivityManager_SPCMtest"
    ...
    sget-object v5, Lcom/android/server/am/SmartAdjustManager;->debuggingR:Lcom/android/server/am/ProcessRecord;

    iget-object v5, v5, Lcom/android/server/am/ProcessRecord;->info:Landroid/content/pm/ApplicationInfo;

    iget-object v5, v5, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v4, v5}, Lcom/android/server/am/SmartAdjustManager;->getShortPackageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v5, v13, Lcom/android/server/am/ServiceRecord;->packageName:Ljava/lang/String;
    ...
    .line 385
    const-string v2, "ActivityManager_SPCM"

    const-string v3, "SPCM start service blocked-- not in active list."
    ...
    .line 391
    sget-boolean v2, Lcom/android/server/am/ActiveServices;->isChinaNal:Z
    ...
    iget-object v3, v13, Lcom/android/server/am/ServiceRecord;->packageName:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lcom/android/server/am/ActivityManagerService;->isAutoRunBlockedApp(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/am/ActivityManagerService;->isNotRunningApp(Ljava/lang/String;)Z
    ...
    const-string v4, "Service blocked - Not running auto run off app with null caller:"
